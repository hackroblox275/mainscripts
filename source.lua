...
function Library.new(config)
	...
	function WindowTable:NewTab(cfg)
		...
		function TabTable:NewSection(c_o_n_f_i_g)
			...
			function SectionTable:NewTextbox(conf)
				...
				function SectionTable:NewParagraph(paragraphConfig)
                  paragraphConfig = Config(paragraphConfig, {
                  Title = "Paragraph Title",
                  Text = "This is a paragraph of text that can be used to display longer descriptions, information, or instructions to the user.",
    ...
    FunctionParagraph.BackgroundTransparency = 0.800
    FunctionParagraph.BorderColor3 = Color3.fromRGB(0, 0, 0)
    FunctionParagraph.BorderSizePixel = 0
    FunctionParagraph.Size = UDim2.new(0.949999988, 0, 0, 100) -- Default height, will be adjusted
    FunctionParagraph.ClipsDescendants = true
    FunctionParagraph.ZIndex = 17
    
    UIAspectRatioConstraint.Parent = FunctionParagraph
    ...
    TitleLabel.Parent = FunctionParagraph
    ...
    TitleLabel.Size = UDim2.new(0.949999988, 0, 0.200000003, 0)
    ...
    ScrollingFrame.Parent = FunctionParagraph
    ScrollingFrame.AnchorPoint = Vector2.new(0.5, 0.5)
    ScrollingFrame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    ScrollingFrame.BackgroundTransparency = 1.000
    ScrollingFrame.BorderColor3 = Color3.fromRGB(0, 0, 0)
    ScrollingFrame.BorderSizePixel = 0
    ScrollingFrame.Position = UDim2.new(0.5, 0, 0.600000024, 0)
    ScrollingFrame.Size = UDim2.new(0.949999988, 0, 0.600000024, 0)
    ScrollingFrame.ZIndex = 18
    ...
    TextContent.Parent = ScrollingFrame
    TextContent.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    TextContent.BackgroundTransparency = 1.000
    TextContent.BorderColor3 = Color3.fromRGB(0, 0, 0)
    TextContent.BorderSizePixel = 0
    TextContent.Size = UDim2.new(1, 0, 0, 0)
    TextContent.ZIndex = 19
    TextContent.Font = Enum.Font.Gotham
    TextContent.Text = paragraphConfig.Text
    TextContent.TextColor3 = paragraphConfig.TextColor
    TextContent.TextSize = paragraphConfig.TextSize
    TextContent.TextTransparency = paragraphConfig.TextTransparency
    TextContent.TextWrapped = paragraphConfig.TextWrapped
    TextContent.TextXAlignment = paragraphConfig.TextXAlignment
    TextContent.TextYAlignment = Enum.TextYAlignment.Top
    ...
    UIGradient_2.Parent = TextContent

    UIStroke.Transparency = 0.950
    UIStroke.Color = Color3.fromRGB(255, 255, 255)
    UIStroke.Parent = FunctionParagraph

    -- Auto-size the paragraph based on text content
    local function updateParagraphHeight()
        if paragraphConfig.AutoHeight then
            local textSize = TextServ:GetTextSize(
                TextContent.Text,
                paragraphConfig.TextSize,
                TextContent.Font,
                Vector2.new(FunctionParagraph.AbsoluteSize.X - 30, math.huge)
            )
            
            local newHeight = math.min(textSize.Y + 60, paragraphConfig.MaxHeight)
            local scrollHeight = math.min(textSize.Y, paragraphConfig.MaxHeight - 60)
            
            ScrollingFrame.Size = UDim2.new(0.949999988, 0, 0, scrollHeight)
            ScrollingFrame.CanvasSize = UDim2.new(0, 0, 0, textSize.Y)
            
            if textSize.Y > (paragraphConfig.MaxHeight - 60) then
                ScrollingFrame.ScrollBarThickness = 4
            else
                ScrollingFrame.ScrollBarThickness = 0
            end
            
            Tween:Create(FunctionParagraph, TweenInfo.new(0.3), {
                Size = UDim2.new(0.949999988, 0, 0, newHeight)
            }):Play()
        end
    end

    -- Update height when text changes
    TextContent:GetPropertyChangedSignal("Text"):Connect(updateParagraphHeight)

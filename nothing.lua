...
function SectionTable:NewParagraph(config)
	config = Config(config, {
		Title = "Paragraph",
		Content = "This is a paragraph with some text content."
	})
	...
	FunctionParagraph.Size = UDim2.new(0.949999988, 0, 0.5, 0)
	...
	TitleLabel.Size = UDim2.new(0.949999988, 0, 0.25, 0)
	...
	ContentLabel.Parent = FunctionParagraph
	ContentLabel.AnchorPoint = Vector2.new(0.5, 0)
	...
	ContentLabel.Position = UDim2.new(0.5, 0, 0.4, 0)
	ContentLabel.Size = UDim2.new(0.949999988, 0, 0.55, 0)
	...
	UIGradient_2.Parent = ContentLabel

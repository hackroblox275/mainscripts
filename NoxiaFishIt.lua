local vu1 = loadstring(game:HttpGet("https://raw.githubusercontent.com/orialdev/WindUI-Forked-by-orialdev/refs/heads/main/WindUI%20Forked"))()
...
local v21 = vu1:CreateWindow({
    Title = "Noxia",
    Icon = "rbxassetid://76536847389638",
    Author = "Fish It",
    Folder = "NoxiaFishIt",
    Size = UDim2.new(0, 280, 0, 320),
    Background = "rbxassetid://76536847389638",
...
Section:Button({
    ...
    Desc = "Join discord server for any bugs",
    Icon = "copy",
    Callback = function()
        setclipboard("https://discord.gg/FTnMTEauXk")
    end
})
v22.I:Section({
    Title = "User Settings",
